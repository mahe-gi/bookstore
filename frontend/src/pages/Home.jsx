  ...
  return (
    <div className=' p-4 '>
        <div className='flex justify-between items-center gap-x-4'> 
            <button className='bg-sky-300 hover:bg-sky-400 px-4 py-1 rounded-lg' onClick={()=>{setShowType('table')}} >
    Table
            </button>

        </div>
        <div className='flex justify-between items-center gap-x-4'> 
            <button className='bg-sky-300 hover:bg-sky-400 px-4 py-1 rounded-lg' onClick={()=>{setShowType('card')}} >
    Card
            </button>
